            ...
            <div class="row">
                ...
                <div class="col-md-8 col-no-margin" id="right">
                    ...
                    <p>
                        ...
                        <br><br>
                        It also includes working with sales, marketing and support to ensure revenue and customer satisfaction goals are met. The Product Manager’s job also includes ensuring that the product and marketing efforts support the company’s overall strategy and goals
                    </p>
                    ...
                    <h3>Requirements</h3>
                    <ul>
                        <li>Minimum of 2 years experience as a Product Manager or Product Marketing Manager</li>
                        <li>Demonstrated success defining and launching excellent products</li>
                        <li>2+ years of experience in a job in the XXX market</li>
                        <li>Excellent written and verbal communication skills</li>
                        <li>Bachelor’s degree in Marketing/ Management</li>
