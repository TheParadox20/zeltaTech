...
<body>
    ...
    <main>
        ...
        <section id=blabla>
            <h1 style="font-family: Samsung Sharp Sans-Bold;font-size: 30px;">Privacy Policy</h1>
            <p>
                Welcome to ZeltaTech.com. This website is owned and operated by ZELTA TECH PRIVATE LIMITED, B-29-30, B-39-40, RIICO Industrial Area, 22 Godown Industrial Area, Jaipur, Rajasthan -302001 India. By visiting our website and accessing the information, resources, services, products, and tools we provide, you understand and agree to accept and adhere to the following terms and conditions as stated in this policy (hereafter referred to as 'User Agreement'), along with the terms and conditions as stated in our Privacy Policy (please refer to the Privacy Policy section below for more information).
                This Privacy Policy governs the manner in which ZeltaTech.com collects, uses, maintains and discloses information collected from users (each, a "User") of the https://zeltatech.com/ website ("Site"). This privacy policy applies to the Site and all products and services offered by ZeltaTech.
            </p>
            ...
            <h1>How We Use The Collected Information</h1>
            <p>
                ZeltaTech may collect and use Users personal information for the following purposes:
                <ul id="blaList">
            ...
            <h1>Compliance With Childrens Protection Online Act</h1>
            <p>
                Protecting the privacy of the very young is especially important. For that reason, we never collect or maintain information at our Site from those we actually know are under 13, and no part of our website is structured to attract anyone under 13.
            </p>
            <h1>Change To This Privacy Policy</h1>
            <p>
                ZeltaTech.com has the discretion to update this privacy policy at any time. When we do, we will send you an email. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.
            </p>
            <h1>Governing Law</h1>
            <p>
                This website is controlled by ZELTA TECH PRIVATE LIMITED from our offices located in the state of Rajasthan, India. All disputes will be subject to Jaipur jurisdiction.
            </p>
            <h1>Contact Us</h1>
            <p>If you have any questions about this Privacy Policy, the practices of this site, or your dealings with this site, please contact us at : hello@zeltatech.com</p>
